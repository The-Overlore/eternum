...
mod trade_systems {
    ...
    impl TradeSystemsImpl of ITradeSystems<ContractState> {
        fn create_order(
            ...
            caravan::check_capacity(world, maker_transport_id, maker_resources_weight);
        ...
        fn accept_order(
            ...
            if taker_transport_id == 0 {
                ...
                resource_chest::lock_until(
                    world, trade.maker_resource_chest_id, ts + maker_transport_one_way_trip_time
                );

                // attach maker's resource chest to maker's transport inventory
                inventory::add(world, trade.maker_transport_id, trade.maker_resource_chest_id);
                ...
                resource_chest::lock_until(
                    world, trade.taker_resource_chest_id, ts + taker_transport_one_way_trip_time
                );

                // attach taker's resource chest to taker's transport inventory
                inventory::add(world, taker_transport_id, trade.taker_resource_chest_id);
                ...
                set!(
                    ...
                    (
                        ...
                        Position {
                            entity_id: taker_transport_id, x: taker_position.x, y: taker_position.y,
                        }
                    )
                );
            };
            ...
            emit!(
                ...
                OrderAccepted {
                    ...
                    taker_id,
                    maker_resources: resource_chest::get_contents(
                        world, trade.maker_resource_chest_id
                    ),
                    taker_resources: resource_chest::get_contents(
